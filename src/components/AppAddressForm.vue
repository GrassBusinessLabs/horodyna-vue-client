<template>
  <div class="text-center">
    <v-btn v-if="!isMenuButton" :block='true' @click="isOpen = true" class='app-color pb-0 rounded-lg btn-text'
      variant='flat'>
      Ввести
    </v-btn>
    <v-list-item-subtitle v-else-if="userAddress" class='my-font-size text-start pb-1'>{{ userAddress.department
