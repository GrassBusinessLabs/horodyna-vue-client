<template>
   <div :class="{ 'inactive-offer': !offer.status }" class='offer-card d-flex flex-column'>
      <div class="offer-image-block">
         <img width="128" :src="linkIMG + '/' + offer.image" alt="Product image" class="offer-image">
      </div>
         ...
         <div>
            <div class="info-text d-flex justify-space-between align-center">
               ...
               <div class="offer-rating d-flex align-center">
                  <svg @click="offerHandler(offer)" width="24" height="24" viewBox="0 0 24 24" fill="none"
               ...
               <div class="d-flex align-center">
                  <div class="d-flex align-center">
                     <svg @click="removeProductFromCart(offer)" width="20" height="20" viewBox="0 0 20 20" fill="none"
                        ...
                        <rect x="5" y="10.5555" width="1.11111" height="10" rx="0.555555"
                           transform="rotate(-90 5 10.5555)" fill="white" />
                     </svg>
                     ...
                     <svg @click="addProductToCart(offer)" width="20" height="20" viewBox="0 0 20 20" fill="none"
                        ...
                        <rect x="5" y="10.5556" width="1.11111" height="10" rx="0.555555"
                           transform="rotate(-90 5 10.5556)" fill="white" />
                     </svg>
                  </div>
               </div>
            </div>
